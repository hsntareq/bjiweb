...
export function ThanaOrgTemplate({ compReport, formatVal, canEdit, onSave, saving }: ReportSectionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <ReportAccordionSection title="৪. ওয়ার্ড সংগঠন:" onEdit={!canEdit ? undefined : () => setIsUnitOrgModalOpen(true)} buttonText="ওয়ার্ড সংগঠন এডিট" icon={LayoutGrid}>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200 text-xs text-center">
            <thead>
              <tr className="bg-blue-50 text-gray-700">
                <th className="border border-gray-200 p-2 text-left">ওয়ার্ডের ধরণ</th>
                <th className="border border-gray-200 p-2">বিগত সংখ্যা</th>
                <th className="border border-gray-200 p-2">বর্তমান সংখ্যা</th>
                <th className="border border-gray-200 p-2">বৃদ্ধি</th>
                <th className="border border-gray-200 p-2">ঘাটতি</th>
            ...
            <tbody>
              {[
                { id: 'generalMale', label: 'সাধারণ ওয়ার্ড সংগঠন (পুরুষ)' },
                { id: 'ulama', label: 'উলামা ওয়ার্ড সংগঠন' },
                { id: 'business', label: 'ব্যবসায়ী ওয়ার্ড সংগঠন' },
                { id: 'laborWelfare', label: 'শ্রমিক কল্যাণ ওয়ার্ড সংগঠন' },
                { id: 'youth', label: 'যুব ওয়ার্ড সংগঠন' },
                { id: 'media', label: 'মিডিয়া ওয়ার্ড সংগঠন' },
                { id: 'culture', label: 'সাহিত্য ও সংস্কৃতি ওয়ার্ড সংগঠন' },
                { id: 'total', label: 'সর্বমোট ওয়ার্ড সংখ্যা' }
              ].map(row => {
      ...
      <ReportAccordionSection title="৫. দাওয়াতী ও পারিবারিক ওয়ার্ড" onEdit={!canEdit ? undefined : () => setIsUnitModalOpen(true)} buttonText="ওয়ার্ড এডিট" icon={Layers}>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200 text-xs text-center">
            <thead>
              <tr className="bg-blue-50 text-gray-700">
            ...
            <tbody>
              {[
                { id: 'dawahUnit', label: 'দাওয়াতী ওয়ার্ড' },
                { id: 'familyUnit', label: 'পারিবারিক ওয়ার্ড' }
              ].map(row => (
                <tr key={row.id}>
                  <td className="border border-gray-200 p-2 text-left font-medium">{row.label}</td>
      ...
      <ReportAccordionSection title="৭. সফর:" onEdit={!canEdit ? undefined : () => setIsSafarModalOpen(true)} buttonText="সফর এডিট" icon={MapPin}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100 text-center">
            <p className="text-[10px] text-emerald-600 font-bold uppercase mb-1">থানা সভাপতি</p>
          ...
          <div className="bg-amber-50 p-3 rounded-lg border border-amber-100 text-center">
            <p className="text-[10px] text-amber-600 font-bold uppercase mb-1">থানা টিম সদস্য</p>
      ...
      <ReportAccordionSection title="৯. সাংগঠনিক বৈঠকাদি:" onEdit={!canEdit ? undefined : () => setIsOrgMeetingModalOpen(true)} buttonText="বৈঠক এডিট" icon={MessagesSquare}>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse border border-gray-200 text-xs text-center">
            ...
            <tbody>
              {[
                { id: 'wardTeam', sl: '১.', label: 'থানা টিম বৈঠক' },
                { id: 'wardMeeting', sl: '২.', label: 'থানা বৈঠক (ওয়ার্ড দায়িত্বশীল সভা)' },
                { id: 'memberMeeting', sl: '৩.', label: 'থানাভিত্তিক মাসিক সদস্য (রুকন)' },
                { id: 'karmiMeeting', sl: '৪.', label: 'ওয়ার্ডে কর্মী বৈঠক/পারিবারিক বৈঠক' },
                { id: 'karmiConference', sl: '৫.', label: 'থানা পর্যায়ে কর্মী সম্মেলন' },
