				...
				<div className="w-full max-w-sm">
					...
					<div className="mt-6 pt-6 border-t border-gray-100 space-y-3 text-center text-sm">
						<button
							...
							className="w-full py-3 px-4 bg-white border border-gray-200 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition-all flex items-center justify-center gap-3 text-sm shadow-sm"
						>
