...
export function UnitBaitulmalTemplate({ compReport, formatVal, canEdit, onSave, saving }: ReportSectionProps) {
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <table className="w-full border-collapse border border-gray-200 text-xs">
        ...
        <tbody>
          <tr>
            <td className="border border-gray-200 p-2">ইয়ানত</td>
          ...
          <tr>
            <td className="border border-gray-200 p-2">এককালীন (ওয়াদা)</td>
            <td className="border border-gray-200 p-2 text-right">{formatVal(compReport.finance?.income?.oneTime)} /=</td>
            <td className="border border-gray-200 p-2">এককালীন (কম্বল)</td>
          ...
          <tr>
            <td className="border border-gray-200 p-2">সমাজসেবা</td>
          ...
          <tr>
            <td className="border border-gray-200 p-2">ফিলিস্তিন</td>
          ...
          <tr>
            <td className="border border-gray-200 p-2">বই বিক্রি</td>
            <td className="border border-gray-200 p-2 text-right">{formatVal(compReport.finance?.income?.fitra)} /=</td>
            <td className="border border-gray-200 p-2">অন্যান্য</td>
