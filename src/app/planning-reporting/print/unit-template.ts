...
table { table-layout: fixed; width: 100% !important; border-collapse: collapse; margin-bottom: 10px; }
table td, table th {
...
.note-text { font-family: "Tiro Bangla"; font-size: 8pt; font-style: italic; font-weight: normal; }
...
.c42{font-size:10pt;font-weight:700;font-family:"Tiro Bangla"}
.c3{font-weight:400;text-decoration:none;vertical-align:baseline;font-size:10pt;font-family:"Tiro Bangla";font-style:normal}
...
<p class="c13 c11" style="font-family: 'Tiro Bangla'; font-size: 10pt;"><strong>(ক) জনসাধারণের মাঝে সর্বমোট দাওয়াত প্রদান সংখ্যা:</strong> {{totalDawahReached}} জন <strong>টার্গেট:</strong> {{totalDawahTarget}} জন</p>

<p class="c13 c11 section-title">১. ইউনিটে নিয়মিত গ্রুপভিত্তিক দাওয়াত:</p>
<table class="border-table">
  <tr>
    <td style="width:25%">কয়টি গ্রুপ বের হয়েছে</td>
    <td style="width:25%">অংশগ্রহণকারীর সংখ্যা</td>
    <td style="width:25%">কতজনের নিকট দাওয়াত পৌঁছানো হয়েছে</td>
    <td style="width:25%">কতজন সহযোগী সদস্য হয়েছেন</td>
  </tr>
  <tr>
    <td>{{groupCount}}</td>
...
<table class="border-table">
  ...
  <tr>
    ...
    <td class="text-left">কতজনের নিকট দাওয়াত পৌঁছানো হয়েছে</td>
  ...
  <tr>
    ...
    <td class="text-left">কতজন সহযোগী সদস্য হয়েছেন</td>
...
<table class="border-table">
  <tr>
    <td style="width:50%">মোট কতজনকে দাওয়াত প্রদান করা হয়েছে</td>
    <td style="width:50%">মোট কতজন সহযোগী সদস্য হয়েছেন</td>
  </tr>
  <tr>
    <td>{{meetingDawahCount}}</td>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:30%">বিবরণ</td>
    <td style="width:15%">মোট গ্রুপ সংখ্যা</td>
    <td style="width:15%">অংশগ্রহণকারী সংখ্যা</td>
    <td style="width:20%">কতজনের নিকট দাওয়াত পৌঁছানো হয়েছে</td>
    <td style="width:20%">কতজন সহযোগী সদস্য হয়েছেন</td>
  </tr>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:25%">ব্যক্তিগত উদ্যোগ</td>
    <td style="width:10%">সদস্য (রুকন)</td>
    <td style="width:10%">কর্মী</td>
    <td style="width:10%">মোট</td>
    <td class="text-left" style="width:30%">সামষ্টিক উদ্যোগ</td>
    <td style="width:15%">মোট সংখ্যা</td>
  </tr>
  <tr>
    <td class="text-left">কতজন কোরআন শিক্ষা প্রদান করেছেন</td>
    <td>{{quranTeacherMember}}</td><td>{{quranTeacherWorker}}</td><td>{{quranTeacherTotal}}</td>
    <td class="text-left">কোরআন শিক্ষার গ্রুপ/শিক্ষার্থী</td><td>{{quranGroupCount}}</td>
  </tr>
  <tr>
    <td class="text-left">কতজনকে কোরআন শিক্ষা প্রদান করা হয়েছে</td>
    <td>{{quranStudentMember}}</td><td>{{quranStudentWorker}}</td><td>{{quranStudentTotal}}</td>
    <td class="text-left">মক্তব/ফোরকানিয়া মাদ্রাসায় কোরআন শিক্ষা গ্রহণকারী</td><td>{{quranMoktobStudentCount}}</td>
  </tr>
  <tr>
    <td class="text-left" colspan="3">কতজন সহীহ তিলাওয়াত শিখেছেন: {{quranSahihCount}}</td>
    <td class="text-left" colspan="2">কতজনের নিকট দাওয়াত পৌঁছানো হয়েছে: {{quranDawahCount}}</td>
    <td class="text-left">কতজন সহযোগী সদস্য হয়েছেন: {{quranAssociateCount}}</td>
  </tr>
</table>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:30%">শ্রেণী-পেশার বিবরণ</td>
    <td style="width:25%">কতজনের মাঝে দাওয়াত পৌঁছানো হয়েছে</td>
    <td style="width:20%">কতজন সহযোগী সদস্য হয়েছেন</td>
    <td style="width:10%">টার্গেট</td>
    <td style="width:15%">বাস্তবায়নের হার</td>
  </tr>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:50%">দাওয়াতি কাজে অংশগ্রহণকারী মোট পরিবার: {{familyDawahParticipant}}</td>
    <td class="text-left" style="width:50%">কতটি নতুন পরিবারে দাওয়াত পৌঁছানো হয়েছে: {{familyDawahNew}}</td>
  </tr>
</table>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:50%">মোট উপযুক্ত জনশক্তি: {{itCapableManpower}}</td>
    <td class="text-left" style="width:50%">মোট অংশগ্রহণকারী সংখ্যা: {{itParticipantCount}}</td>
  </tr>
</table>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:20%">বিবরণ</td>
  ...
  <tr>
    <td class="text-left">বই বিলিকেন্দ্র</td><td>{{pubBookCenterTotal}}</td><td>{{pubBookCenterInc}}</td><td>{{pubBookCenterTarget}}</td>
    <td class="text-left">বইয়ের সফট কপি বিলি (সংগঠন অনুমোদিত)</td><td>{{pubSoftCopyTotal}}</td><td>{{pubSoftCopyInc}}</td>
  </tr>
  <tr>
    <td class="text-left">বিলি কেন্দ্রে বই</td><td>{{pubBookInCenterTotal}}</td><td>{{pubBookInCenterInc}}</td><td>{{pubBookInCenterTarget}}</td>
    <td class="text-left">দাওয়াতী লিংক বিতরণ</td><td>{{pubDawahLinkTotal}}</td><td>{{pubDawahLinkInc}}</td>
  </tr>
  <tr>
    <td class="text-left">বই বিলি/বিক্রি</td><td>{{pubBookDistTotal}}</td><td>{{pubBookDistInc}}</td><td>{{pubBookDistTarget}}</td>
    <td class="text-left">সোনার বাংলা/সংগ্রাম/পৃথিবী কত কপি চলে</td><td>{{pubMagazineTotal}}</td><td>{{pubMagazineInc}}</td>
  </tr>
</table>
...
<table class="border-table">
  <tr>
    <td style="width:5%">ক্রম</td>
    <td class="text-left" style="width:45%">কর্মসূচীর বিবরণ</td>
...
<table class="border-table">
  <tr>
    <td rowspan="2" class="text-left" style="width:25%">জনশক্তির ধরণ</td>
    <td rowspan="2" style="width:15%">বিগত সময়ের সংখ্যা</td>
    <td rowspan="2" style="width:15%">বর্তমান সংখ্যা</td>
    <td colspan="2" style="width:15%">বৃদ্ধি</td>
    <td rowspan="2" style="width:10%">ঘাটতি</td>
    <td rowspan="2" style="width:10%">টার্গেট</td>
    <td rowspan="2" style="width:10%">বাস্তবায়নের হার</td>
  </tr>
  <tr>
    <td>মানোন্নয়ন</td><td>আগত</td>
  </tr>
  <tr><td class="text-left">মোট সদস্য (রুকন)</td><td>{{manpowerMemberPrev}}</td><td>{{manpowerMemberCurr}}</td><td>{{manpowerMemberIncUp}}</td><td>{{manpowerMemberIncIn}}</td><td>{{manpowerMemberDec}}</td><td>{{manpowerMemberTarget}}</td><td>{{manpowerMemberRate}}</td></tr>
  <tr><td class="text-left">মোট কর্মী</td><td>{{manpowerWorkerPrev}}</td><td>{{manpowerWorkerCurr}}</td><td>{{manpowerWorkerIncUp}}</td><td>{{manpowerWorkerIncIn}}</td><td>{{manpowerWorkerDec}}</td><td>{{manpowerWorkerTarget}}</td><td>{{manpowerWorkerRate}}</td></tr>
  <tr><td class="text-left">মোট সক্রিয় সহযোগী সদস্য</td><td>{{manpowerActiveAssocPrev}}</td><td>{{manpowerActiveAssocCurr}}</td><td>{{manpowerActiveAssocIncUp}}</td><td>{{manpowerActiveAssocIncIn}}</td><td>{{manpowerActiveAssocDec}}</td><td>{{manpowerActiveAssocTarget}}</td><td>{{manpowerActiveAssocRate}}</td></tr>
</table>

<p class="c13 c11 section-title">২. সহযোগী সদস্য ও ভিন্নধর্মালম্বী:</p>
<table class="border-table">
  <tr>
    <td class="text-left" style="width:30%">সহযোগী</td>
    <td style="width:15%">বিগত সময়ের সংখ্যা</td>
    <td style="width:15%">বর্তমান সংখ্যা</td>
    <td style="width:10%">বৃদ্ধি</td>
    <td style="width:15%">টার্গেট</td>
    <td style="width:15%">বাস্তবায়নের হার</td>
  </tr>
  <tr><td class="text-left">মোট সহযোগী সদস্য</td><td>{{assocTotalPrev}}</td><td>{{assocTotalCurr}}</td><td>{{assocTotalInc}}</td><td>{{assocTotalTarget}}</td><td>{{assocTotalRate}}</td></tr>
  <tr><td class="text-left">ভিন্নধর্মালম্বী কর্মী/সহযোগী সদস্য</td><td>{{assocOtherPrev}}</td><td>{{assocOtherCurr}}</td><td>{{assocOtherInc}}</td><td>{{assocOtherTarget}}</td><td>{{assocOtherRate}}</td></tr>
</table>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:25%">ইউনিটের ধরন</td>
    <td style="width:15%">বিগত সময়ের সংখ্যা</td>
    <td style="width:15%">বর্তমান সংখ্যা</td>
    <td style="width:10%">বৃদ্ধি</td>
    <td style="width:10%">ঘাটতি</td>
    <td style="width:10%">টার্গেট</td>
    <td style="width:15%">বাস্তবায়নের হার</td>
  </tr>
  <tr><td class="text-left">মোট পারিবারিক ইউনিট</td><td>{{familyUnitPrev}}</td><td>{{familyUnitCurr}}</td><td>{{familyUnitInc}}</td><td>{{familyUnitDec}}</td><td>{{familyUnitTarget}}</td><td>{{familyUnitRate}}</td></tr>
</table>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:40%">ইয়ানতদাতার ধরণ</td>
    <td style="width:30%">সংখ্যা</td>
    <td style="width:30%">টাকার পরিমাণ</td>
  </tr>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:40%">কর্মসূচীর ধরণ</td>
    <td style="width:20%">সংখ্যা</td>
    <td style="width:20%">টার্গেট</td>
    <td style="width:20%">উপস্থিতি</td>
  </tr>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:40%">সর্বমোট কতজন জনশক্তি ব্যক্তিগত উদ্যোগে সামাজিক কাজ করেছেন</td><td style="width:10%">{{socialPersonalWorkerCount}}</td>
    <td class="text-left" style="width:40%">সর্বমোট সেবাপ্রাপ্ত সংখ্যা</td><td style="width:10%">{{socialPersonalServiceCount}}</td>
  </tr>
  <tr>
    <td class="text-left">মোট কতজন স্বাস্থ্যসেবা কাজে অংশগ্রহণ করেছেন</td><td>{{socialHealthWorkerCount}}</td>
...
<table class="border-table">
  ...
  <tr>
    <td class="text-left">সামাজিক অনুষ্ঠানে অংশগ্রহণ সংখ্যা/সহায়তা প্রদান কতজনকে</td><td>{{socialUnitEventAtt}}</td>
    <td class="text-left">মাতৃত্বকালীন সময়ে সেবা প্রদান/নবজাতক গিফট প্রদান (মোট কতজনকে)</td><td>{{socialUnitMaternity}}</td>
  </tr>
  <tr>
    <td class="text-left">সামাজিক বিরোধ মীমাংসা/জনসচেতনতামূলক প্রোগ্রাম</td><td>{{socialUnitConflict}}</td>
    <td class="text-left">রোগীর পরিচর্যা/চিকিৎসা সহায়তা প্রদান/স্বেচ্ছায় রক্তদান (কতজনকে)</td><td>{{socialUnitPatientCare}}</td>
  </tr>
  <tr>
    <td class="text-left">মানবিক সহায়তা প্রদান/কর্জে হাসানা প্রদান (মোট কতজনকে)</td><td>{{socialUnitHumanitarian}}</td>
    <td class="text-left">মাইয়্যেতের গোসল/জানাযায় অংশগ্রহণ (কতজন)</td><td>{{socialUnitFuneral}}</td>
  </tr>
  <tr>
    <td class="text-left">টেকনিক্যাল সেবা প্রদান (কতজন/কতজনকে)</td><td>{{socialUnitTech}}</td>
    <td class="text-left">বৃক্ষরোপন (কতটি)</td><td>{{socialUnitTree}}</td>
  </tr>
  <tr>
    <td class="text-left">ভিন্নধর্মাবলম্বীদের সেবা (কতজন/কতজনকে)</td><td>{{socialUnitOtherReligions}}</td>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:35%">রাজনৈতিক ব্যক্তিবর্গের সাথে যোগাযোগ</td><td style="width:15%">{{statePolComm}}</td>
    <td class="text-left" style="width:35%">বিশিষ্ট ব্যক্তিবর্গের সাথে যোগাযোগ</td><td style="width:15%">{{stateEminentComm}}</td>
  </tr>
  <tr>
...
<table class="border-table">
  <tr>
    <td class="text-left" style="width:35%">আয়ের বিবরণ</td><td style="width:15%"></td>
    <td class="text-left" style="width:35%">ব্যয়ের বিবরণ</td><td style="width:15%"></td>
  </tr>
...
<table style="width: 100%; border: none; margin-top: 10px; font-size: 10pt; font-family: 'Tiro Bangla'; vertical-align: top;">
  <tr>
