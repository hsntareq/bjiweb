"use client";
import { ArrowRight, Lock, Package, Phone } from "lucide-react";
	...
	return (
		<div className="min-h-screen flex">
			...
			<div className="hidden lg:flex lg:w-5/12 xl:w-1/2 relative overflow-hidden bg-[#0d0d1a] flex-col">
				<div className="absolute top-1/3 -left-20 w-80 h-80 bg-indigo-600 rounded-full opacity-20 blur-3xl pointer-events-none" />
				<div className="absolute bottom-1/3 right-0 w-72 h-72 bg-violet-700 rounded-full opacity-20 blur-3xl pointer-events-none" />
				<div className="relative z-10 flex flex-col justify-between h-full p-10">
					...
					<div>
						<h2 className="text-4xl font-extrabold text-white leading-tight">
							Sign In with<br />
							<span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">Your Phone.</span>
						</h2>
						<p className="mt-4 text-indigo-200/50 text-sm leading-relaxed max-w-xs">
							Use your mobile number and password to access your BJI OMS account quickly and securely.
						</p>
					</div>
			...
			<div className="flex-1 flex items-center justify-center bg-white px-6 py-12">
				<div className="w-full max-w-sm">
					...
					<h1 className="text-2xl font-extrabold text-gray-900 mb-1">Phone sign in</h1>
					<p className="text-gray-400 text-sm mb-8">Enter your mobile number and password</p>
					...
					<div className="mt-6 pt-6 border-t border-gray-100 space-y-3 text-center text-sm">
						<Link href="/login" className="block text-indigo-600 hover:text-indigo-700 font-medium transition-colors">
